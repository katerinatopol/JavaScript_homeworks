...
const map = {
     ...
     */
    render(snakePointsArray, foodPoint, breakPoint) {
        ...
        // Получаем элемент ячейки с препятствием по точке breakPoint
...
const game = {
    ...
    reset() {
        ...
        // Ставим препятствие на карту в случайную пустую ячейку.
        this.breakIT.setCoordinates(this.getRandomFreeCoordinates());
    ...
    tickHandler() {
        ...
        if (this.food.isOnPoint(this.snake.getNextStepHeadPoint())) {
            ...
            this.food.setCoordinates(this.getRandomFreeCoordinates());
            // Ставим препятствие в свободную ячейку
            this.breakIT.setCoordinates(this.getRandomFreeCoordinates());
        ...
        // Если следующий шаг будет на препятствие, то заходим в if.
        if (this.breakIT.isOnPointBreak(this.snake.getNextStepHeadPoint())) {
    ...
    /**
     * Отображает все для игры, карту, еду, препятствие и змейку.
     */
    render() {
        this.map.render(this.snake.getBody(), this.food.getCoordinates(), this.breakIT.getCoordinates());
    },
